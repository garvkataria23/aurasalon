...
@Component({
  ...
  `,
  styles: [`
    .alerts-workspace { background: #f0f2f5; color: #111827; min-height: 100vh; gap: 8px; padding: 8px; }
    ...
    .badge { display: inline-block; border-radius: 999px; background: #F5EEF2; color: #8B5E7C; padding: 5px 9px; font-weight: 800; font-size: 12px; text-transform: uppercase; }
