...
const catalog: IntegrationCategory[] = [
  {
    ...
    integrations: [
      ...
      card('atom-ntt-data', 'payments-india', 'NTT DATA / Atom', 'ATOM', '#0f766e', 'Accept cards, UPI and net banking through Atom/NTT DATA.', 'Connect NTT DATA Atom payments', paymentFields.indiaGateway, ['upi', 'cards', 'netbanking'], [], { region: 'India', paymentModes: ['Cards', 'UPI', 'NetBanking'] }),
      ...
      card('pinelabs-reader', 'payments-india', 'Pine Labs Reader', 'PIN', '#0f766e', 'Connect Pine Labs readers for front desk billing.', 'Connect Pine Labs reader', paymentFields.terminal, ['terminal', 'cards', 'upi'], [], { region: 'India', paymentModes: ['POS', 'Cards', 'UPI'] }),
  ...
  },
  {
    ...
    integrations: [
      ...
      card('ach-debit', 'payments-global', 'ACH Direct Debit', 'ACH', '#0f766e', 'Collect US bank account payments and recurring debits.', 'Configure ACH debit', paymentFields.directDebit, ['bank-debit', 'recurring', 'us'], [], { region: 'US', paymentModes: ['Bank debit'] }),
      ...
      card('spei', 'payments-global', 'SPEI', 'SPEI', '#0f766e', 'Accept Mexican bank transfer payments through SPEI.', 'Connect SPEI payments', paymentFields.localMethod, ['bank-transfer', 'mexico'], [], { region: 'Mexico', paymentModes: ['Bank transfer'] }),
