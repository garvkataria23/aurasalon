...
staffTaskRouter.patch("/staff-os/tasks/:id", canWriteStaffTasks, route((req, res) => res.json(staffTaskService.updateTask(req.params.id, req.body, req.access))));
staffTaskRouter.post("/staff-os/tasks/:id/comments", canWriteStaffTasks, route((req, res) => res.status(201).json(staffTaskService.addTaskComment(req.params.id, req.body, req.access))));
