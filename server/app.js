...
import { ensureOversightCommandCenterSchema } from "./services/oversight-command-center-schema.service.js";
...
import { ownerFinanceReportsRouter } from "./routes/owner-finance-reports.routes.js";
import { ownerAppointmentsRouter } from "./routes/owner-appointments.routes.js";
import { ownerPeopleRouter } from "./routes/owner-people.routes.js";
import { ownerOperationsRouter } from "./routes/owner-operations.routes.js";
import { ownerAdministrationRouter } from "./routes/owner-administration.routes.js";
import { ownerBillingRouter } from "./routes/owner-billing.routes.js";
import { ownerPosHandoffPublicRouter } from "./routes/owner-pos-handoff.routes.js";
...
export function createApp() {
  ...
  app.use("/api/v1", ownerPosHandoffPublicRouter);
  ...
  app.use("/api/v1", ownerFinanceReportsRouter);
  app.use("/api/v1", ownerAppointmentsRouter);
  app.use("/api/v1", ownerPeopleRouter);
  app.use("/api/v1", ownerOperationsRouter);
  app.use("/api/v1", ownerAdministrationRouter);
  app.use("/api/v1", ownerBillingRouter);
  ...
  app.use("/api/v1", oversightCommandCenterRouter);
  app.use("/api/v1", gdprRouter);
  app.use("/api/v1", apiKeyRouter);
  app.use("/api/v1", auditChainRouter);
  app.use("/api/v1", siemRouter);
  ...
  app.use("/api/v1", salesToolsRouter);
  app.use("/api/v1", authenticateJwt(), inventoryIntelligenceRouter);
  app.use("/api/v1", laundryEntryRouter);
  ...
  app.use("/api", mfaPublicRouter);
  app.use("/api", webauthnPublicRouter);
  ...
  app.use("/api", authenticateJwt(), realtimeRouter);
