...
@Component({
  ...
  styles: [`
    ...
    @media (max-width: 900px) {
      ...
      .scroll-top-button { position: fixed; right: 14px; bottom: calc(88px + env(safe-area-inset-bottom)); z-index: 28; display: grid; place-items: center; width: 42px; height: 42px; border: 1px solid rgba(184,122,20,.3); border-radius: 999px; background: rgba(247,215,127,.78); color: #281806; font-size: .78rem; font-weight: 950; box-shadow: 0 10px 22px rgba(139,93,21,.16); }
