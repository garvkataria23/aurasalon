            ...
            {filteredFeatures.map((feature, featureIndex) => {
              ...
              return (
                <Link
                  key={feature.title}
                  href={feature.href}
                  className="feature-card-hover group flex flex-col justify-between rounded-3xl border border-[var(--aura-border)] bg-white p-8 cursor-pointer"
                >
                  <div>
                    <div
                      className="w-13 h-13 rounded-2xl flex items-center justify-center mb-6 transition-all duration-300 group-hover:scale-112 group-hover:rotate-2 shadow-xs"
                      style={{ backgroundColor: `${feature.color}15` }}
                    >
                      <Icon className="w-6 h-6 transition-transform" style={{ color: feature.color }} />
                    </div>
                    <h2 className="text-lg font-bold text-[var(--aura-heading)] mb-2.5 group-hover:text-[var(--aura-purple)] transition-colors flex items-center justify-between">
                      ...
                      <ArrowUpRight className="h-4 w-4 text-[var(--aura-muted)] opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 group-hover:text-[var(--aura-purple)] transition-all duration-200" />
                    </h2>
                  ...
                  <div className="mt-6 pt-4 border-t border-[var(--aura-border)]/50 flex items-center justify-between text-xs font-semibold text-[var(--aura-purple)]">
