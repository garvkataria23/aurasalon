    ...
    >
      ...
      >
        <button
          ref={closeRef}
          onClick={dismiss}
          className="absolute top-4 right-4 z-10 w-10 h-10 rounded-full bg-aura-surface-muted flex items-center justify-center text-aura-text-muted hover:text-aura-text transition-colors"
        ...
        <div className="p-8 text-center">
          {submitted ? (
            <div>
              ...
              <h3 id="exit-title" className="text-2xl font-bold text-aura-text mb-2">
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-aura-border bg-aura-bg text-sm text-aura-text placeholder:text-aura-text-muted focus:outline-none focus:ring-2 focus:ring-aura-primary/30 focus:border-aura-primary transition-all"
                />
                <button
                  type="submit"
                  className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 text-sm font-semibold text-white rounded-full bg-aura-primary hover:bg-aura-primary-dark transition-colors"
                >
