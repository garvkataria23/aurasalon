        ...
        <div className="grid gap-6 grid-cols-1 sm:grid-cols-3">
          {HARDWARE.map((device, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`reveal stagger-${idx + 1} rounded-[var(--aura-radius-xl)] border border-[var(--aura-border)] bg-white p-6 transition-all duration-300 hover:shadow-[var(--aura-shadow-md)] flex flex-col items-center text-center`}
              >
